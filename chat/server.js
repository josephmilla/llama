...
function init() {
    registerUser("Llama Slama", "en-US", "zh-CN");
    registerUser("Mama Llama", "zh-CN", "en-US");
    registerUser("c", "zh-CN", "en-US");
    registerUser("d", "zh-CN", "en-US");
    registerUser("e", "zh-CN", "en-US");
	sendMessage("Hey", "Llama Slama", "Mama Llama");
	sendMessage("Yo", "Llama Slama", "Mama Llama");
	sendMessage("I like you", "Mama Llama", "Llama Slama");
	sendMessage("asds", "c", "Llama Slama");
}
init();
